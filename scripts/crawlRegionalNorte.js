// =================================================================
// ZENIT - V2 RAW CRAWLER (VEA & CHANGOMÁS - REGIONAL NORTE)
...
function fetchVtexSearch(baseUrl, query, from = 0, to = 49) {
...
async function run() {
  console.log('🌵 Iniciando Cosecha RAW de Vea & ChangoMás (Regional Norte)...');
  ...
  const SOURCES = [
    {
      ...
      queries: [
        ...
        'panaderia', 'congelados', 'quesos', 'fiambres',
        // Keywords y marcas regionales del NOA
  ...
  for (const source of SOURCES) {
    ...
    for (const query of source.queries) {
      ...
      while (true) {
        ...
        // Condición de corte: array vacío significa fin del catálogo para esa query
